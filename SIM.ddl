...
DROP TABLE SIM_membership CASCADE CONSTRAINTS ;
...
CREATE TABLE SIM_membership
  (
    membership_id          INTEGER NOT NULL ,
    SIM_person_person_id   INTEGER ,
    SIM_project_project_id INTEGER
  ) ;
ALTER TABLE SIM_membership ADD CONSTRAINT SIM_membership_PK PRIMARY KEY ( membership_id ) ;
...
ALTER TABLE SIM_membership ADD CONSTRAINT SIM_membership_SIM_person_FK FOREIGN KEY ( SIM_person_person_id ) REFERENCES SIM_person ( person_id ) ;

ALTER TABLE SIM_membership ADD CONSTRAINT SIM_membership_SIM_project_FK FOREIGN KEY ( SIM_project_project_id ) REFERENCES SIM_project ( project_id ) ;
